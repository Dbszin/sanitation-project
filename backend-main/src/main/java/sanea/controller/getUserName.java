...
public class getUserName implements HttpHandler {
    @Override
    ...
    private void handleGet(HttpExchange exchange) throws IOException {
        try {
            ...
            System.err.println("[getUserName] Erro ao buscar dados do usuário: " + e.getMessage());
            e.printStackTrace();
            
            String response = "{\"error\": \"Erro ao buscar dados do usuário: " + e.getMessage() + "\"}";
            exchange.getResponseHeaders().set("Content-Type", "application/json");
